...
public class BasicTerminalMethods {
    ...
    public static void main(String[] args) {
        ...
        stringList
                .stream()
                .forEach(s -> System.out.println(s.concat("_2")));

        //forEachOrdered - the same forEach but with guaranteed order(parallel stream)
        stringList
                .parallelStream()
                .forEachOrdered(s -> System.out.println(s.concat("_2")));
        ...
        System.out.println(strWithIntList
                .stream()
        ...
        IntStream intStream = integerList
                .stream()
                .mapToInt(p -> p);
